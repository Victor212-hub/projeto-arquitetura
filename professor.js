// ── Configuração de animações e efeitos visuais para o painel do professor ──
...
function adicionarEfeitosAosCards() {
  ...
  cards.forEach((card) => {
    card.addEventListener('mouseenter', function() {
      this.style.boxShadow = '0 12px 35px rgba(52, 73, 94, 0.2)';
...
function adicionarEfeitosAosBotoes() {
  ...
  botoes.forEach((botao, index) => {
    ...
    botao.addEventListener('mouseenter', function() {
      ...
      this.style.boxShadow = '0 8px 20px rgba(52, 73, 94, 0.3)';
      this.style.transition = 'all 0.3s ease';
    });
